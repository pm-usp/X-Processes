...
def process_individual_pair(population, evaluated_population, crossover_probability, max_perc_of_num_tasks_for_crossover, task_mutation_probability, gateway_mutation_probability, max_perc_of_num_tasks_for_task_mutation, max_perc_of_num_tasks_for_gateway_mutation, reference_cromossome, alphabet, input_log_name, round, island, generation, on_off_task_mutation_probability, max_perc_of_num_tasks_for_on_off_task_mutation, cache_soundness, cache_petri_net, cache_n_tokens, act_fix_mode):
    ...
    offspring1, offspring2 = opr.crossover_per_process(crossover_probability, max_perc_of_num_tasks_for_crossover, offspring1, offspring2, reference_cromossome, cache_n_tokens)
    opr.mutation(offspring1, task_mutation_probability, gateway_mutation_probability, max_perc_of_num_tasks_for_task_mutation, max_perc_of_num_tasks_for_gateway_mutation, reference_cromossome, island, on_off_task_mutation_probability, max_perc_of_num_tasks_for_on_off_task_mutation, cache_n_tokens, act_fix_mode)
    opr.mutation(offspring2, task_mutation_probability, gateway_mutation_probability, max_perc_of_num_tasks_for_task_mutation, max_perc_of_num_tasks_for_gateway_mutation, reference_cromossome, island, on_off_task_mutation_probability, max_perc_of_num_tasks_for_on_off_task_mutation, cache_n_tokens, act_fix_mode)
    number_of_sound_attempts = 0
    alphabet_len_half = int(len(alphabet) * 0.5)
    while not pn.is_sound(offspring1, alphabet, input_log_name, round, island, generation, cache_soundness, cache_petri_net) or not pn.is_sound(offspring2, alphabet, input_log_name, round, island, generation, cache_soundness, cache_petri_net):
        offspring1 = np.copy(population[chosen_individual_1])
        offspring2 = np.copy(population[chosen_individual_2])
...
@decorators.measure_time
def generation(population, reference_cromossome, evaluated_population, crossover_probability, max_perc_of_num_tasks_for_crossover, task_mutation_probability, gateway_mutation_probability, max_perc_of_num_tasks_for_task_mutation, max_perc_of_num_tasks_for_gateway_mutation, elitism_percentage, sorted_evaluated_population, alphabet, fitness_weight, precision_weight, generalization_weight, simplicity_weight, input_log_name, round, island, generation, on_off_task_mutation_probability, max_perc_of_num_tasks_for_on_off_task_mutation, cache_fitness, cache_soundness, cache_petri_net, cache_n_tokens, act_fix_mode, cached_sampled_xes_log, cached_remaining_xes_log, last_file_size_sampled_xes_log, last_file_size_remaining_xes_log):
    ...
    if elitism_percentage > 0:
        evaluated_aux_population, cached_sampled_xes_log, cached_remaining_xes_log, last_file_size_sampled_xes_log, last_file_size_remaining_xes_log = fit.evaluate_population(auxiliary_population, alphabet, fitness_weight, precision_weight, generalization_weight, simplicity_weight, input_log_name, round, island, generation, cache_fitness, cache_petri_net, cached_sampled_xes_log, cached_remaining_xes_log, last_file_size_sampled_xes_log, last_file_size_remaining_xes_log)
        ...
        evaluated_new_population, cached_sampled_xes_log, cached_remaining_xes_log, last_file_size_sampled_xes_log, last_file_size_remaining_xes_log = fit.evaluate_population(auxiliary_population, alphabet, fitness_weight, precision_weight, generalization_weight, simplicity_weight, input_log_name, round, island, generation, cache_fitness, cache_petri_net, cached_sampled_xes_log, cached_remaining_xes_log, last_file_size_sampled_xes_log, last_file_size_remaining_xes_log)
    return auxiliary_population, evaluated_new_population, cached_sampled_xes_log, cached_remaining_xes_log, last_file_size_sampled_xes_log, last_file_size_remaining_xes_log
